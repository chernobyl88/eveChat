...
class Managers{
	 ...
	 * 			0 means that the {@see \Library\Manager} is a general one
	 * 			1 means that the {@see \Library\Manager} is in a specific module
	 * 
	 * @throws \InvalidArgumentException
	 * 			If no model has been given
	 * 
	 * @return \Library\Manager
	 */
	public function getManagersOf($model, $location = 1){
